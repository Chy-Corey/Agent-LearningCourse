...
## [概览 (Overview)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#概览-overview)
...
## [用法 (Usage)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#用法-usage)
...
#### [生产环境 (In production)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#生产环境-in-production)
...
## [自定义代理记忆 (Customizing agent memory)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#自定义代理记忆-customizing-agent-memory)
...
## [常见模式 (Common patterns)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#常见模式-common-patterns)
...
#### [修剪消息 (Trim messages)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#修剪消息-trim-messages)
...
#### [删除消息 (Delete messages)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#删除消息-delete-messages)
...
#### [总结消息 (Summarize messages)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#总结消息-summarize-messages)
...
## [访问记忆 (Access memory)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#访问记忆-access-memory)

您可以通过几种方式访问和修改代理的短期记忆（状态）：

#### [工具 (Tools)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#工具-tools)

##### [在工具中读取短期记忆 (Read short-term memory in a tool)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#在工具中读取短期记忆-read-short-term-memory-in-a-tool)
...
##### [从工具写入短期记忆 (Write short-term memory from tools)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#从工具写入短期记忆-write-short-term-memory-from-tools)
...
#### [提示 (Prompt)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#提示-prompt)
...
#### [模型之前 (Before model)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#模型之前-before-model)
...
#### [模型之后 (After model)](https://langchain-doc.cn/v1/python/langchain/short-term-memory.html#模型之后-after-model)
