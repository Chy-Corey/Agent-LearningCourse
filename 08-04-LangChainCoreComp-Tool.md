...
## [创建工具 (Create tools)](https://langchain-doc.cn/v1/python/langchain/tools.html#创建工具-create-tools)

### [基本工具定义 (Basic tool definition)](https://langchain-doc.cn/v1/python/langchain/tools.html#基本工具定义-basic-tool-definition)
...
### [自定义工具属性 (Customize tool properties)](https://langchain-doc.cn/v1/python/langchain/tools.html#自定义工具属性-customize-tool-properties)

#### [自定义工具名称 (Custom tool name)](https://langchain-doc.cn/v1/python/langchain/tools.html#自定义工具名称-custom-tool-name)
...
#### [自定义工具描述 (Custom tool description)](https://langchain-doc.cn/v1/python/langchain/tools.html#自定义工具描述-custom-tool-description)
...
### [高级架构定义 (Advanced schema definition)](https://langchain-doc.cn/v1/python/langchain/tools.html#高级架构定义-advanced-schema-definition)
...
## [访问上下文 (Accessing Context)](https://langchain-doc.cn/v1/python/langchain/tools.html#访问上下文-accessing-context)
...
### [ToolRuntime](https://langchain-doc.cn/v1/python/langchain/tools.html#toolruntime)
...
#### [上下文 (Context)](https://langchain-doc.cn/v1/python/langchain/tools.html#上下文-context)
...
#### [内存（存储）(Memory (Store))](https://langchain-doc.cn/v1/python/langchain/tools.html#内存-存储-memory-store)
...
#### [流写入器 (Stream Writer)](https://langchain-doc.cn/v1/python/langchain/tools.html#流写入器-stream-writer)
